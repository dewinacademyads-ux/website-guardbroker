...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed h-18 sm:h-18 top-0 py-1 z-50 w-full dark:bg-transparent transition-all ${
        sticky
          ? 'shadow-lg bg-white dark:shadow-dark-md dark:bg-darklight!'
          : 'shadow-none'
      }`}>
      <div className='container mx-auto max-w-6xl flex items-center justify-between px-4 sm:px-6 py-3'>
        <Logo />
        ...
        <div className='flex items-center gap-3 sm:gap-4'>
          ...
          <Link
            ...
            className='hidden lg:block bg-transparent border border-primary text-primary px-4 py-2 rounded-lg text-sm hover:bg-blue-800 hover:text-white transition'>
            Entrar
          </Link>
          <Link
            href='https://trade.guardbroker.com/pt/register'
            className='hidden lg:block bg-primary text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition'>
            Criar conta
          </Link>
      ...
      <div
        ...
        <nav className='flex flex-col items-start p-4 gap-1'>
          ...
          <div className='mt-4 flex flex-col gap-3 w-full'>
            <Link
              href='https://trade.guardbroker.com/pt/login'
              className='bg-transparent border border-primary text-primary px-4 py-2 rounded-lg text-sm hover:bg-blue-800 hover:text-white transition'
              onClick={() => setNavbarOpen(false)}>
              Entrar
            </Link>
            <Link
